...
export default ({object, error, size, name, label, options, onChange}: { object: any, error: IError, size: number, name: string, label: string, options: ISelectOption[], onChange: IInputChangeHandler }) => {
  ...
  return (
    <div className={cssGroup}>
      ...
      <div className='col-sm-10'>
        <select size={size} className='form-control' name={name} onChange={handleOnChange} value={selectedValue}>
